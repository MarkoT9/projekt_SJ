<?php
// Inklúzia pripojenia k databáze a triedy produktov
include_once 'classes/Db_connection.php';
include_once 'classes/Product.php';

// Skontrolovanie, či bol formulár odoslaný
...
<script>
    $(function () {
        // Inicializácia jQuery UI datepicker na poli expire_date
        $('#expire_date').datepicker({
            dateFormat: 'yy-mm-dd'  // Formátovanie dátumu na yyyy-mm-dd
        });
    });
</script>
</body>
